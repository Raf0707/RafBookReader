...
sealed class MainEvent {
    ...
    data class OnChangeBookTranslationSourceLanguage(val value: String) : MainEvent()
    data class OnChangeBookTranslationTargetLanguage(val value: String) : MainEvent()
    data class OnChangeBookTranslationProgressInBottomBar(val value: Boolean) : MainEvent()
    data class OnChangeBookTranslationPartialNotice(val value: Boolean) : MainEvent()
    data class OnChangeBookTranslationKeepPartialOnCancel(val value: Boolean) : MainEvent()
